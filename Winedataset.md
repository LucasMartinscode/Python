{
  ...
  "cells": [
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "provincias = ['California', 'Washington', 'Oregon']      #Criando dicionários de dados\n",
        "\n",
